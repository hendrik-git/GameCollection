...
namespace Engine::Components
{
	...
	/// @details The components should ideally be free from logic and contain pure data. However
	/// this implementation is very narrowly focused and convenient to use.
	class Animation
	{
	  public:
	  ...
	  protected:
		...
		Animation(std::string name, const sf::Texture& texture);
		...
		Animation(std::string name, const sf::Texture& texture, size_t frame_count, size_t speed);
