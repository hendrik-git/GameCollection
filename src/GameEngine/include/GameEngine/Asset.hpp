...
namespace Engine::Asset
{
	...
	class Assets
	{
	  public:
		...
		[[nodiscard]] auto get_shader_names() const -> std::vector<std::string>;

		/// @brief Returns a vector of names (keys) for the stored fonts
		[[nodiscard]] auto get_font_names() const -> std::vector<std::string>;

		/// @brief Returns a vector of names (keys) for the stored textures
		[[nodiscard]] auto get_texture_names() const -> std::vector<std::string>;

		/// @brief Returns a vector of names (keys) for the stored sounds
		[[nodiscard]] auto get_sound_names() const -> std::vector<std::string>;
